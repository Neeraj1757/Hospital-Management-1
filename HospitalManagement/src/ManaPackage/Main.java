...
import ManaPackage.Patient;
import ManaPackage.PatientDao;
import ManaPackage.PatientDaoInterface;
public class Main {
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 3:
				...
				if (!f)
					System.err.println("Patient with this id does not exist.");
